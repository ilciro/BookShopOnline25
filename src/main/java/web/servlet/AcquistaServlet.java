...
public class AcquistaServlet extends HttpServlet {
	...
	private static final PersistenzaLibro pL=new laptop.database.libro.LibroDao();
	private static final PersistenzaGiornale pG=new laptop.database.giornale.GiornaleDao();
	private static final PersistenzaRivista pR=new laptop.database.rivista.RivistaDao();
