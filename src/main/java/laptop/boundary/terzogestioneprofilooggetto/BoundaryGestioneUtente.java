...
public class BoundaryGestioneUtente implements Initializable {
    ...
    @FXML
    private void inserisci() throws IOException, CsvValidationException, IdException, ClassNotFoundException {
    ...
    @FXML
    private void modifica() throws IOException, CsvValidationException, IdException, SQLException, ClassNotFoundException {
