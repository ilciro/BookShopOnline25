        ...
        boolean status = false;
            ...
            switch (vis.getType())
            {
                case LIBRO -> {
                    ...
                    if(status) Logger.getLogger("elimina book").log(Level.INFO,"eliminated book with id .{0}",vis.getIdLibro());
                ...
                case RIVISTA ->{
                    ...
                    if(status) Logger.getLogger("elimina rivista").log(Level.INFO," eliminated magazine with id .{0}",vis.getIdRivista());
