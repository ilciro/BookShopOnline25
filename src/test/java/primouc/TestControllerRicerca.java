...
class TestControllerRicerca {
    ...
    void testRicercaLibroT(String strings) throws CsvValidationException, IOException, ClassNotFoundException, IdException {
        assertNotNull(cR.listaLibri(RBOGGETTO.getString("titoloL"),strings));
    }
    @ParameterizedTest
    @ValueSource(strings = {"database","file","memoria"})
    void testRicercaLibroE(String strings) throws CsvValidationException, IOException, ClassNotFoundException, IdException {
        assertNotNull(cR.listaLibri(RBOGGETTO.getString("editoreL"),strings));
    }
    @ParameterizedTest
    @ValueSource(strings = {"database","file","memoria"})
    void testRicercaLibroA(String strings) throws CsvValidationException, IOException, ClassNotFoundException, IdException {
