...
class TestGestioneOggettoLibro {
    ...
    void testInsertLibro(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file"})
    void testModifLibro(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
        vis.setTipologiaApplicazione("full");
        vis.setTypeAsBook();
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file"})
    void testRemoveLibro(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
        vis.setTipologiaApplicazione("full");
        vis.setTypeAsBook();
        vis.setIdLibro(Integer.parseInt(RBOGGETTO.getString("idL")));
        //login
