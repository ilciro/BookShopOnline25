...
class TestGestioneOggettoGiornale {
    ...
    void testInsertGiornale(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file"})
    void testModifGiornale(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
        vis.setTipologiaApplicazione("full");
        vis.setTypeAsDaily();
