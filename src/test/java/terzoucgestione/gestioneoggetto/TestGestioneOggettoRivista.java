...
@TestMethodOrder(MethodOrderer.MethodName.class)
 ...
 class TestGestioneOggettoRivista {
    ...
    void testInsertRivista(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file"})
    void testModifRivista(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
        vis.setTipologiaApplicazione("full");
        vis.setTypeAsMagazine();
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file"})
    void testRemoveRivista(String strings) throws CsvValidationException, SQLException, IOException, IdException, ClassNotFoundException {
        vis.setTipologiaApplicazione("full");
        vis.setTypeAsMagazine();
        vis.setIdLibro(Integer.parseInt(RBOGGETTO.getString("idR")));
        //login
