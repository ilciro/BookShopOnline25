...
class TestGestioneUtenteAdminMem {
    ...
    void testInserisciUtente(String strings)  {
        vis.setTipologiaApplicazione("memoria");
        //login
    ...
    @ParameterizedTest
    @ValueSource(strings = {"memoria"})
    void testModifUtente(String strings)  {
        vis.setTipologiaApplicazione("memoria");
        //login
        cL.login(RBUTENTE.getString("emailA"),RBUTENTE.getString("passA"),strings);
        //prendo lista
    ...
    @ParameterizedTest
    @ValueSource(strings = {"memoria"})
    void testRemoveUtente(String strings) {
        vis.setTipologiaApplicazione("memoria");
        //login
        cL.login(RBUTENTE.getString("emailA"),RBUTENTE.getString("passA"),strings);
        //prendo lista
