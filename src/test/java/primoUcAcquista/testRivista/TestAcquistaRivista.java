...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class TestAcquistaRivista {
    ...
    void testAcquistaRivistaCash(String strings) throws CsvValidationException, SQLException, IOException, ClassNotFoundException, IdException, DocumentException, URISyntaxException {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"database","file","memoria"})
    void testAcquistaRivistaCredito(String strings) throws CsvValidationException, SQLException, IOException, ClassNotFoundException, IdException {
        ...
        boolean status=cSN.isOpen(strings,3)&&cSN.isValid(strings,3);
        assertFalse(status);
    }

    @ParameterizedTest
    @ValueSource(strings = {"database","file","memoria"})
    void testAcquistaRivista(String strings) throws CsvValidationException, SQLException, IOException, ClassNotFoundException, IdException {
        //inizializzo tabella giornale
        vis.setTypeAsMagazine();
